local function init()
    ...
    map('n','<C-s>', ':lua require("harpoon.ui").nav_file(1)<CR>',options)
    map('n','<C-d>', ':lua require("harpoon.ui").nav_file(2)<CR>',options)
    map('n','<C-f>', ':lua require("harpoon.ui").nav_file(3)<CR>',options)
    map('n','<C-g>', ':lua require("harpoon.ui").nav_file(4)<CR>',options)
